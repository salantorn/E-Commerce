        ...
        <div className="row gy-4">
          ...
          <div className="col-12 col-md-4">
            ...
            <div className="social-icons d-flex mt-3">
              ...
              <a href="mailto:salantornlol@gmail.com" className="neumorph-social-icon me-2" aria-label="อีเมล">
                <i className="bi bi-google"></i>
              </a>
              <a href="tel:0644847858" className="neumorph-social-icon me-2" aria-label="โทรศัพท์">
          ...
          <div className="col-6 col-md-4">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2 d-flex">
                ...
                <span><a href="tell:0644847858">เบอร์โทรศัพท์</a></span>
              </li>
              <li className="mb-2 d-flex">
                <i className="bi bi-envelope me-2"></i>
                <span><a href="mailto:salantornlol@gmail.com">salantorn</a></span>
              </li>
              <li className="mb-2 d-flex">
